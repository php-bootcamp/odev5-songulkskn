        ...
        <div class="row">
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <?php endwhile; ?>
                    <td>
                        <a href="islemler.php/delete/id=<?= $product->uniqid; ?>"  class="btn btn-button btn-danger">Sil</a>
                    </td>
                    <td>
                        <a href="islemler.php/update/id=<?= $product->uniqid; ?>" class="btn btn-button btn-warning">Güncelle</a>
                    </td>
                </tr>
